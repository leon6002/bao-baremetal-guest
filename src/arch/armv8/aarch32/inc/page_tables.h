...
#define PTE_PXN   (0x1 << 1)
#define PTE_B   (0x1 << 2)
#define PTE_C   (0x1 << 3)
#define PTE_XN   (0x1 << 4)
#define PTE_DOMAIN_OFF (5)
#define PTE_DOMAIN_MSK (0xf << PTE_DOMAIN_OFF)
#define PTE_DOMAIN(N)   (((N) << PTE_DOMAIN_OFF) & PTE_DOMAIN_MSK)
#define PTE_A               (1 << 10) // AP[0]
#define PTE_AP_OFF          (11)
#define PTE_AP_MSK          (0x11 << PTE_AP_OFF)
#define PTE_AP_RW_PRIV      (0x00 << PTE_AP_OFF)
#define PTE_AP_RW           (0x01 << PTE_AP_OFF)
#define PTE_AP_RO_PRIV      (0x10 << PTE_AP_OFF)
#define PTE_AP_RO           (0x11 << PTE_AP_OFF)
#define PTE_TEX_OFF         (12)
#define PTE_TEX_MSK         (0x7 << PTE_TEX_OFF)
#define PTE_TEX(T)          (((T) << PTE_TEX_OFF) & PTE_TEX_MSK)
#define PTE_S               (0x1 << 16)
#define PTE_nG              (0x1 << 17)
